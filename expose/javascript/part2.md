...
Question 15 -> 
== in JavaScript is used for comparing two variables, but it ignores the datatype of variable and === is used for comparing two variables, but this operator also checks datatype and compares two values.
